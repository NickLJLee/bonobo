...
class ResNet_EEG(nn.Module):
    def __init__(self, ResBlock, SpectralConv1d, n_channal, init_threshold, num_classes):
        ...
        self.conv1 = nn.Sequential(
            nn.Conv1d(n_channal, 64, kernel_size=7, stride=2, padding=1, bias=False),
            nn.BatchNorm1d(64),
            nn.ReLU()
        )
        ...
        self.fft64 = SpectralConv1d(64, 64, init_threshold = 0.2, signal_shape = 126) #498 126
        self.fft128 = SpectralConv1d(128, 128, init_threshold = 0.2, signal_shape = 63) #63
        self.fft256 = SpectralConv1d(256, 256, init_threshold = 0.2, signal_shape = 32) #32
        self.fft512 = SpectralConv1d(512, 512, init_threshold= 0.2, signal_shape = 16)  #16
